...
const approvedKnowledgeEventsRouter =
  require("./routes/approved-knowledge-events");
...
/*
|--------------------------------------------------------------------------
| Security and Administrative Cache Protection
|--------------------------------------------------------------------------
*/
...
function isAdministrativeRequest(request) {
  ...
  return (
    ...
    requestPath === "/admin-report.html" ||
    requestPath === "/admin-report.js" ||
    requestPath === "/admin-report.css" ||
...
/*
|--------------------------------------------------------------------------
| Protected Reporting Administration API
|--------------------------------------------------------------------------
|
| Routes provided:
|
| GET /admin/reporting/health
| GET /admin/reporting/totals
| GET /admin/reporting/knowledge
| GET /admin/reporting/categories
| GET /admin/reporting/daily
...
/*
|--------------------------------------------------------------------------
| Approved Knowledge Reporting Event Ingestion
|--------------------------------------------------------------------------
|
| Routes provided:
|
| GET  /chat/approved-knowledge/events/health
| POST /chat/approved-knowledge/events
|
|--------------------------------------------------------------------------
*/
...
const server =
  app.listen(
    ...
    function () {
      ...
      console.log(
        "Approved knowledge reporting ingestion API:",
        {
          mounted:
            true,
          ...
          healthEndpoint:
            "/chat/approved-knowledge/events/health"
        }
      );
      ...
      console.log(
        "Admin reporting API:",
        {
          ...
          totalsEndpoint:
            "/admin/reporting/totals",

          knowledgeEndpoint:
            "/admin/reporting/knowledge",

          categoriesEndpoint:
            "/admin/reporting/categories",

          dailyEndpoint:
            "/admin/reporting/daily",

          eventsEndpoint:
            "/admin/reporting/events"
        }
      );
